...
if ismember(hostname, {'kaikai1' 'hnb228-labpc5'}),
    fake_rp_box = 3;
...
switch hostname
    ...
    case 'hnb228-labpc5'
        ...
        state_machine_properties.server = '10.20.29.46';
      ...
      %  state_machine_properties.server = '10.102.30.56';
        ...
        state_machine_properties.output_routing = {struct('type', 'dout','data', '10-19'); struct('type', 'noop','data', '9')}; % Breakout box ports 1-4
        state_machine_properties.input_events = [6 -6]; % Get beam break input from breakout box port 1
